...
/***/ "./src/styles/create_account.scss":
/*!****************************************!*\
  !*** ./src/styles/create_account.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!****************************************************!*\
  !*** ./src/pages/create_account/create_account.js ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_create_account_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../styles/create_account.scss */ "./src/styles/create_account.scss");
...
/* harmony import */ var _utils_add_footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/add_footer */ "./src/utils/add_footer.js");
/* harmony import */ var _utils_scroll_to_top__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/scroll_to_top */ "./src/utils/scroll_to_top.js");
/* harmony import */ var _utils_scroll_to_top__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_utils_scroll_to_top__WEBPACK_IMPORTED_MODULE_5__);
...
var sign_in_cont = document.querySelector(".sign_in"),
...
function on_sign_in_submit(e) {
  e.preventDefault();
  (0,_utils_firebase__WEBPACK_IMPORTED_MODULE_3__.sign_in_with_email_and_password)(gather_form_info(e.target)).then(on_success)["catch"](on_sign_in_failure); // я хз чого, але блок catch не спрацьовує, коли виникає помилка fetch запиту
}
function on_sign_up_submit(e) {
  e.preventDefault();
  (0,_utils_firebase__WEBPACK_IMPORTED_MODULE_3__.create_user_with_email_and_password)(gather_form_info(e.target)).then(on_success)["catch"](on_sign_up_failure);
}
function gather_form_info(form) {
  var user_info_iterator = new FormData(form).entries();
  var user_info = {};
  var _iterator = _createForOfIteratorHelper(user_info_iterator),
    _step;
  try {
...
document.querySelectorAll(".google-login-button").forEach(function (btn) {
  btn.addEventListener("click", function () {
    (0,_utils_firebase__WEBPACK_IMPORTED_MODULE_3__.sign_in_with_popup)();
  });
});
var sign_in_btn = document.querySelector(".sign-up-link"),
  sign_up_btn = document.querySelector(".sign-in-link");
[sign_in_btn, sign_up_btn].forEach(function (el, _i, array) {
  el.addEventListener("click", function () {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        var form_classlist = btn.parentNode.parentNode.classList;
